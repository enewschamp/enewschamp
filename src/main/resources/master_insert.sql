...
Insert into city (city_Id,name_Id,description,state_Id,country_Id,Operator_Id,operation_Date_Time,record_In_Use) values (2, 'Delhi', 'Delhi','DEL','IN','SYSTEM', CURRENT_DATE, 'Y');
