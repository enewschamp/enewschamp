...
public class FeePaymentPageHandler implements IPageHandler {
	...
	public PageDTO loadPage(PageNavigationContext pageNavigationContext) {
		...
		paramMap.put("MID", propertiesService.getProperty(PropertyConstants.PAYTM_DETAILS_MID));
		...
		paramMap.put("INDUSTRY_TYPE_ID",
				propertiesService.getProperty(PropertyConstants.PAYTM_DETAILS_INDUSTRY_TYPE_ID));
		paramMap.put("CHANNEL_ID", propertiesService.getProperty(PropertyConstants.PAYTM_DETAILS_CHANNEL_ID));
		paramMap.put("TXN_AMOUNT", "" + studentPaymentWork.getPayAmount());
		paramMap.put("WEBSITE", propertiesService.getProperty(PropertyConstants.PAYTM_DETAILS_WEBSITE));
		paramMap.put("EMAIL", "");
		paramMap.put("MOBILE_NO", "");
		paramMap.put("CALLBACK_URL",
				propertiesService.getProperty(PropertyConstants.PAYTM_DETAILS_CALLBACK_URL) + paramMap.get("ORDER_ID"));
		try {
//			String checkSum = CheckSumServiceHelper.getCheckSumServiceHelper().genrateCheckSum(
//					propertiesService.getProperty(PropertyConstants.PAYTM_DETAILS_MERCHANT_KEY), paramMap);
...
//					propertiesService.getProperty(PropertyConstants.PAYTM_DETAILS_MERCHANT_KEY), inResponse,
//					checkSumHash);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
