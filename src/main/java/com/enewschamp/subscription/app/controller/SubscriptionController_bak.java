...
public class SubscriptionController_bak {
	...
	public ResponseEntity<StudentSubscriptionDTO> update(
			@RequestBody @Valid StudentSubscriptionDTO StudentSubscriptionDTO, @PathVariable Long studentId) {
	...
	public ResponseEntity<StudentSubscriptionDTO> patch(@RequestBody StudentSubscriptionDTO StudentSubscriptionDTO,
	...
	public ResponseEntity<StudentSubscriptionDTO> get(@PathVariable Long studentId, @PathVariable Long editionId) {
		StudentSubscriptionDTO StudentSubscriptionDTO = null;
		// StudentSubscription StudentSubscription =
		// studentSubscriptionService.get(studentId, editionId);
		// StudentSubscriptionDTO StudentSubscriptionDTO =
		// modelMapper.map(StudentSubscription, StudentSubscriptionDTO.class);
		// studentSubscriptionService.get(studentId, editionId);
		return new ResponseEntity<StudentSubscriptionDTO>(StudentSubscriptionDTO, HttpStatus.OK);
	}
