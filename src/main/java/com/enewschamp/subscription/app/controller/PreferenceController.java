...
import com.enewschamp.subscription.app.dto.StudentPreferencesPageDTO;
...
public class PreferenceController {
	...
	public ResponseEntity<StudentPreferencesPageDTO> processNext(@PathVariable Long studentId,
			@RequestBody @Valid StudentPreferencesPageDTO preferenceDto) {
		...
		// List<UIControlsDTO> uiControls =
		// uiControlService.getByScreenAndAction(fromScreen,action);
		// preferenceDto.setScreenProperties(uiControls);
		// preferenceDto.getHeader().setRequestStatus(RequestStatusType.S);
		return new ResponseEntity<StudentPreferencesPageDTO>(preferenceDto, HttpStatus.CREATED);
	}

	@PostMapping(value = "/page/preference/action/prev/student/{studentId}")
	public ResponseEntity<StudentPreferencesPageDTO> processPrev(@PathVariable Long studentId,
			@RequestBody @Valid StudentPreferencesPageDTO preferenceDto) {
