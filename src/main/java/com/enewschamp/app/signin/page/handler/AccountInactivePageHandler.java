...
@Component(value = "AccountInactivePageHandler")
public class AccountInactivePageHandler implements IPageHandler {
	...
	public PageDTO loadPage(PageNavigationContext pageNavigationContext) {
		...
		AccountInactivePageData accountInactivePageData = new AccountInactivePageData();
		accountInactivePageData
				.setMessage("Your account is temporarily inactive!! Please reach out to helpdesk team!!");
		pageDto.setData(accountInactivePageData);
		return pageDto;
	}
