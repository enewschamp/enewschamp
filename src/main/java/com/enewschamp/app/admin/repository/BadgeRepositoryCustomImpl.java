package com.enewschamp.app.admin.repository;
...
public class BadgeRepositoryCustomImpl extends RepositoryImpl implements IGenericListRepository<Badge> {
	...
	public Page<Badge> findAll(Pageable pageable, AdminSearchRequest searchRequest) {
		...
		criteriaQuery.orderBy(cb.desc(badgeRoot.get(CommonConstants.OPERATION_DATE_TIME)));
		// Build query
		...
		long count = getRecordCount(criteriaQuery, filterPredicates, badgeRoot);
