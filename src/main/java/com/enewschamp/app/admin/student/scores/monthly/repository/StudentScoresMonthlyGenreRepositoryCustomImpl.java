...
@Repository
public class StudentScoresMonthlyGenreRepositoryCustomImpl extends RepositoryImpl
		implements IGenericListRepository<StudentScoresMonthlyGenre>, AdminConstant {
	...
	public Page<StudentScoresMonthlyGenre> findAll(Pageable pageable, AdminSearchRequest searchRequest) {
		...
		criteriaQuery.orderBy(cb.desc(studentScoresDailyRoot.get(CommonConstants.SCORE_YEAR_MONTH)),
				cb.desc(studentScoresDailyRoot.get(CommonConstants.GENRE_ID)),
