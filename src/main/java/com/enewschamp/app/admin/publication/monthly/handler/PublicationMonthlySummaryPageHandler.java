...
@Component("PublicationMonthlySummaryPageHandler")
public class PublicationMonthlySummaryPageHandler implements IPageHandler {
	@Autowired
	...
	private PageDTO listPublicationMonthlySummary(PageRequestDTO pageRequest) {
		...
		Page<PublicationMonthlySummary> monthlySummaryList = dailySummaryService.listPublicationMonthlySummary(
				searchRequest,
	...
	public List<PublicationMonthlySummaryPageData> mapPublicationMonthlySummaryData(
			Page<PublicationMonthlySummary> page) {
		...
		if (page != null && page.getContent() != null && page.getContent().size() > 0) {
			List<PublicationMonthlySummary> pageDataList = page.getContent();
			for (PublicationMonthlySummary userLogin : pageDataList) {
