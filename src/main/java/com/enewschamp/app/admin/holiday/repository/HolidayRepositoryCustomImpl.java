package com.enewschamp.app.admin.holiday.repository;
...
@Repository
public class HolidayRepositoryCustomImpl extends RepositoryImpl implements IGenericListRepository<Holiday>{
