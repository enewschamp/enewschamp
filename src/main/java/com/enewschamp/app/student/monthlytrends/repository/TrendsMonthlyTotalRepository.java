...
public interface TrendsMonthlyTotalRepository extends JpaRepository<TrendsMonthlyTotal, Long> {
	...
	@Query("select d from TrendsMonthlyTotal d where d.studentId = :studentId and d.editionId= :editionId and d.readingLevel= :readingLevel and d.yearMonth= :yearMonth and d.recordInUse ='Y'")
	public Optional<TrendsMonthlyTotal> getMonthlyTrends(@Param("studentId") Long studentId,
